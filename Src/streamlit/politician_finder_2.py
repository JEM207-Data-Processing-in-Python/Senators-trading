...
def most_trade_type_politician(data: pd.DataFrame, selected_politician: str) -> str:
    """
    Identifies the most frequent trade type (quoteType) the selected politician invests in,
    based on the "Purchase" transactions in the dataset.
    ...
    Returns:
    - str: A message indicating which trade type the politician invests the most in.

    Note:
    - Returns a message about purchases if they exist; otherwise, indicates no purchases.
    """
    try:
...
def most_traded_volume_politician(data: pd.DataFrame, selected_politician: str) -> str:
    """
    Identifies the total volume of the most traded instrument (quoteType) by the selected politician,
    ...
    Returns:
    - str: A message indicating the total average amount purchased by the politician.

    Note:
    - Returns the amount purchased for the most traded instrument or an empty string if no data is available.
    """
    try:
...
def most_traded_sector_politician(data: pd.DataFrame, selected_politician: str) -> str:
    """
    Identifies the most traded sector and its total volume for equity investments (quoteType == 'EQUITY') by the selected politician.
    ...
    Returns:
    - str: A message indicating the most traded sector for equity investments and its total volume.

    Note:
    - Returns a message about equity investments in a sector if available; otherwise, indicates no data.
    """
    try:
...
def most_sold_sector_politician(data: pd.DataFrame, selected_politician: str) -> str:
    """
    Identifies the most sold sector and its total volume for equity sales (quoteType == 'EQUITY') by the selected politician.
    ...
    Returns:
    - str: A message indicating the most sold sector for equity sales and its total volume.

    Note:
    - Returns a message about equity sales in a sector if available; otherwise, indicates no data.
    """
    try:
