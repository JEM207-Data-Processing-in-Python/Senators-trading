...
st.write(
    ...
    - **[Instrument Finder](Instrument_Finder)**: Displays how politicians are investing in individual financial instruments, along with the performance and gains of those instruments.

    - **[Align Your Investment Strategy](Align_Your_Investment_Strategy)**: On this page, you can input your investing strategies, and it will show you the politicians whose strategies most closely align with yours. This way, you can adapt your overall strategy to align with the strategies of influential politicians.

    Designed as a Streamlit-based application, this tool offers an engaging way to gain insights into senator's trading behaviors and even provides answers to well-known questions about insider trading among politicians.
    """
)
...
st.write(
    ...
    - **[Yahoo Finance](https://finance.yahoo.com/)**: To complement the trading data, we use the Yahoo Finance API to fetch historical and real-time market data for financial instruments. This includes stock prices, performance trends, and metadata about the financial assets being traded. By integrating this data, we can offer in-depth analyses, such as how specific trades by senators align with market performance and whether they hint at patterns of potential insider trading.
